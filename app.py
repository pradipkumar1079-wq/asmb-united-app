...
# ==========================================
    ...
    with st.expander("📖 View Official Rating & Foul Scoring Guide Panel"):
        ...
        **Rating Scale Guide (0.0 to 10.0):**
        ...
        - **9.0 - 9.9:** ম্যাচের সেরা পারফরম্যান্স, যেখানে একাধিক গোল, অ্যাসিস্ট বা পুরো ম্যাচ নিয়ন্ত্রণের ভূমিকা থাকে{একাধিক নিশ্চিত গোল বাঁচানো (Solo Saves) ও পেনাল্টি আটকে ম্যাচের সেরা হওয়া}
        - **8.0 - 8.9:** দুর্দান্ত ম্যাচ, যেখানে নির্ণায়ক গোল, গুরুত্বপূর্ণ অ্যাসিস্ট বা দারুণ রক্ষণভাগ দেখা যায়{দুর্দান্ত শট-স্টপিং, ক্লিনশিট রাখা এবং রক্ষণভাগকে সফলভাবে নেতৃত্ব দেওয়া}
        - **7.0 - 7.9:** গড়ের চেয়ে ভালো পারফরম্যান্স, যেখানে সঠিক পজিশনিং ও কার্যকর পাসিং থাকে{নির্ভরযোগ্য গোলকিপিং, গড়ের চেয়ে ভালো পজিশনিং ও নির্ভুল পাস/লং বল দেওয়া}
        - **6.0 - 6.9:** গড়পড়তা পারফরম্যান্স (বেস রেটিং), যেখানে কোনো বড় ভুল বা বিশেষ অবদান কোনটিই থাকে না{সাধারণ পারফরম্যান্স (বেস রেটিং), যেখানে বিশেষ কোনো সেভ করার সুযোগ আসেনি বা কোনো ভুলও হয়নি}
        - **5.0 - 5.9:** মানহীন খেলা, যেখানে সুযোগ নষ্ট হওয়া বা নিষ্ক্রিয় উপস্থিতি স্পষ্ট থাকে{দুর্বল সিদ্ধান্ত, ভুল পজিশনিং বা বল ক্লিয়ার করতে গিয়ে অস্বস্তিতে পড়া}
        - **3.0 - 4.9:** বাজে পারফরম্যান্স, যেখানে পেনাল্টি মিস বা গোল খাওয়ার পেছনে সরাসরি দায় থাকে{গোলকিপারের স্পষ্ট ভুলে গোল খাওয়া বা বক্সে মারাত্মক ভুল সিদ্ধান্ত নেওয়া}
        - **0.0 - 2.9:** বিপর্যয়কর খেলা, যেখানে লাল কার্ড, আত্মঘাতী গোল বা দলের হারের প্রধান কারণ হওয়া বোঝায়{বিপর্যয়কর পারফরম্যান্স, যার মধ্যে লাল কার্ড খাওয়া, আত্মঘাতী গোল করা বা একাধিক সহজ গোল ছেড়ে দেওয়া অন্তর্ভুক্ত}
        """)
