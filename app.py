...
# ==========================================
    ...
    with st.expander("📖 View Official Rating & Foul Scoring Guide Panel"):
        ...
        **Rating Scale Guide (0.0 to 10.0):**
        - **10.0:** নিখুঁত ও ইতিহাস সৃষ্টিকারী পারফরম্যান্স (যেমন: হ্যাট্রিক, ৪-৫ গোল বা অবিশ্বাস্য একক নেতৃত্ব)
        - **9.0 - 9.9:** ম্যাচের সেরা পারফরম্যান্স, যেখানে একাধিক গোল, অ্যাসিস্ট বা পুরো ম্যাচ নিয়ন্ত্রণের ভূমিকা থাকে
        - **8.0 - 8.9:** দুর্দান্ত ম্যাচ, যেখানে নির্ণায়ক গোল, গুরুত্বপূর্ণ অ্যাসিস্ট বা দারুণ রক্ষণভাগ দেখা যায়
        - **7.0 - 7.9:** গড়ের চেয়ে ভালো পারফরম্যান্স, যেখানে সঠিক পজিশনিং ও কার্যকর পাসিং থাকে
        - **6.0 - 6.9:** গড়পড়তা পারফরম্যান্স (বেস রেটিং), যেখানে কোনো বড় ভুল বা বিশেষ অবদান কোনটিই থাকে না
        - **5.0 - 5.9:** মানহীন খেলা, যেখানে সুযোগ নষ্ট হওয়া বা নিষ্ক্রিয় উপস্থিতি স্পষ্ট থাকে
        - **3.0 - 4.9:** বাজে পারফরম্যান্স, যেখানে পেনাল্টি মিস বা গোল খাওয়ার পেছনে সরাসরি দায় থাকে
        - **0.0 - 2.9:** বিপর্যয়কর খেলা, যেখানে লাল কার্ড, আত্মঘাতী গোল বা দলের হারের প্রধান কারণ হওয়া বোঝায়
        """)
